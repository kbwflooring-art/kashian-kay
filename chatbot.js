(function () {
  ...
  style.innerHTML = [
    '#kb-chat-btn{position:fixed;bottom:24px;right:24px;width:60px;height:60px;border-radius:50%;border:none;background:#5bcdc7;color:#fff;font-size:24px;cursor:pointer;z-index:999998;box-shadow:0 8px 30px rgba(0,0,0,0.2);transition:transform .2s ease;display:flex;align-items:center;justify-content:center;}',
    ...
    '.kb-inline-btn{font-family:inherit;cursor:pointer;background:#fff;border:1.5px solid #0891b2;color:#0891b2;border-radius:6px;padding:5px 10px;font-size:12px;font-weight:500;white-space:normal;line-height:1.3;text-align:center;}',
  ...
  btn.id = 'kb-chat-btn';
  btn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="white"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>';
