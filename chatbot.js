...
`;
  ...
  // =========================
  // WAIT FOR DOM (FIXES DISAPPEARING ISSUE)
  // =========================
  ...
  window.addEventListener("DOMContentLoaded", function () {
    ...
    * { box-sizing: border-box; }
    ...
    .k-header { padding:16px; background:#5bcdc7; display:flex; gap:10px; }
    ...
    .k-typing { font-size:13px; opacity:0.7; }
    `;
